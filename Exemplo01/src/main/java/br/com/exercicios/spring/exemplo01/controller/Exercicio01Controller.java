...
public class Exercicio01Controller {
    ...
    private final Exercicio01Service exercicio01Service;

    public Exercicio01Controller(Exercicio01Service exercicio01Service) {
        this.exercicio01Service = exercicio01Service;
    }
